                                    ...
                                    for i in range(len(key_split)):
                                        ...
                                        if i == 0:
                                            ...
                                            if k_2 not in sportCatalog_tree[k_0]["regionIds"][k_1]["competitionIds"]:
                                                # añado el key al diccionario
                                                sportCatalog_tree[k_0]["regionIds"][k_1]["competitionIds"][k_2] = {"competitionId": k_2, "competitionName": v_2, "eventId": {}}
                                        elif i == 3:
                                            # obtengo el key 0
                                            k_0 = key_split[0]
                                            # obtengo el value 0
                                            ...
                                            v_3 = value_split[3]
                                            # verifico si el key no esta en sportCatalog_tree
                                            if k_3 not in sportCatalog_tree[k_0]["regionIds"][k_1]["competitionIds"][k_2]["eventId"]:
                                                # añado el key al diccionario
                                                sportCatalog_tree[k_0]["regionIds"][k_1]["competitionIds"][k_2]["eventId"][k_3] = {"eventId": k_3, "eventName": v_3}
                            # verifica si sportCatalog_tree no esta vacio
                            if sportCatalog_tree:
                                # guardo el diccionario en un archivo json
                                with open("sportCatalog_tree.json", "w") as file:
